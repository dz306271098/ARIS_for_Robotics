...
| Setting | Value | Why |
|---------|-------|-----|
| Codex CLI reasoning_effort (`codex exec`) | **xhigh** | Reviewer quality is non-negotiable |
...
| proof-checker | rigor | key steps only | full proof + gaps | + alternative proofs | exhaustive + counterexample search |
| paper-claim-audit | claims audited | top-3 | all major | all major + minor | every claim + evidence chain |
...
| proof-checker | review rounds | 1 | 3 | 4 | 5 |
| paper-claim-audit | re-audit after fixes | skip | 1 | 2 | 3 |
| experiment-audit | audit depth | basic | standard | full | line-by-line |
| deepxiv | reading depth | brief only | brief+head | brief+head+section | full progressive |
| alphaxiv | tiers explored | tier 1 only | tier 1-2 | tier 1-3 | tier 1-3 + cross-ref |
...
```
[effort: max] papers=25, ideas=16, rounds=6 | Codex CLI: xhigh (always)
```
