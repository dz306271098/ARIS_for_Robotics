...
description: "Use when experiments complete to judge what claims the results support, what they do not, and what evidence is still missing. A Gemini reviewer via gemini-review MCP evaluates the evidence, then the executor routes to salvage, supplement, or confirmation."
