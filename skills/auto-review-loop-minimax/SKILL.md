...
description: Autonomous multi-round research review loop using MiniMax API. Use when you want to use MiniMax instead of Codex CLI for external review. Trigger with "auto review loop minimax" or "minimax review".
...
**Why MiniMax instead of Codex CLI?** Codex CLI uses OpenAI's Responses API (`/v1/responses`) which is not supported by third-party providers. See: https://github.com/openai/codex/discussions/7782
