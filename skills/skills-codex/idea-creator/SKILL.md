...
Use a secondary Codex agent for deliberate divergent thinking. Do NOT ask for one pooled brainstorm first. Generate ideas lane by lane using `../shared-references/innovation-lanes.md`:
