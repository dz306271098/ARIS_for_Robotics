...
**What this does:**
- Claude review acts as a grant review panelist (not a paper reviewer)
...
**What this does:**
- Claude review acts as a grant review panelist
...
Implement CRITICAL and MAJOR fixes. If MAX_REVIEW_ROUNDS > 1, re-submit for another round via `mcp__claude-review__review_reply_start` plus `mcp__claude-review__review_status`.
