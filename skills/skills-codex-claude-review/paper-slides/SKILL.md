...
Send the slide outline + selected LaTeX frames to Claude review:
...
> ⚠️ If `claude-review` MCP is not available or Claude CLI login is missing, skip external review and proceed to Phase 6. Note the skip in `SLIDES_STATE.json`.
