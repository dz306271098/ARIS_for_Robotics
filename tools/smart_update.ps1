...
# ARIS Smart Skill Update (PowerShell) — LEGACY TOOL for cp-based installs.
#
# ⚠️  RECOMMENDED for new installs: use install_aris.ps1 (flat junctions + manifest).
#     Junction installs update instantly after `git pull` in the ARIS repo;
#     no merge tool needed. This script is for users with a legacy cp-r install
#     who want to diff + merge upstream changes into their local copies.
#
